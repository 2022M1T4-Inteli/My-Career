...
var score = 0 
# variavel para a contagem de score
...
func _ready():
	...
	if GameManager.startMinigamems == true: #Verifica se outro diálogo ja esta em cena
		GameManager.startMinigamems = false
...
func _process(delta):
	...
	if escolha >=3:
		...
		$pontos.text="Pontos: " + str(score)
		#imprimi os score na tela 
		Dialogic.set_variable("esxppoints", score)
		#if para aumentar o numero de escolhas, colocar os score na variavel global e imprimir os score na tela 
